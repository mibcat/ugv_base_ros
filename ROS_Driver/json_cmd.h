...
// {"T":92} get motor PID settings
#define CMD_GET_MOTOR_PID 92
...
// it won't be controlled by broadcast mac address, and add one mac to
// whitelist. if there is no leader you can just fill 00:00:00:00:00:00 in it.
